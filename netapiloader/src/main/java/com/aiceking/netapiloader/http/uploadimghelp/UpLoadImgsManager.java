...
public class UpLoadImgsManager {
    ...
    private String city;
    public UpLoadImgsManager(String city,Activity activity, String upLoadImgUrl){
...
public void upLoadImage(Activity context, String path){
    imgUploadThreadPool.execute(new UpLoadImgRunnable(city,handler,context,path,upLoadImgUrl));
}
